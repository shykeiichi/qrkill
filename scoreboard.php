...
$sql = 'SELECT COUNT(qr_kills.id) AS score, qr_users.name, qr_users.class FROM qr_players JOIN qr_kills JOIN qr_users ON qr_kills.killer = qr_users.id = qr_players.qr_users_id WHERE qr_players.qr_events_id = ?';
